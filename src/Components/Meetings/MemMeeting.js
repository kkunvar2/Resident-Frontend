...
const MemMeeting = () => {
    ...
    //for taggling only one card
    const toggleConclusion = (index) => {
        const newShow = [...show];
  ...
  return (
    <>
        <div className='h-screen bg-gray-900'>
            ...
            {/* Card 1 */}
            <div className="relative max-w-sm p-5 bg- border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className='flex justify-between item-center'>
                    ...
                    <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Society</h5>
                    <p className=" text-xl font-bold text-yellow-500 dark:text-gray-400 mt-1">1</p>
                </div>
                <div className='flex item-center mt-2'>
                    <div className='flex flex-col'>
                        <p className=" font-normal text-gray-500 dark:text-gray-400">Date: <span className='text-slate-800'>15/03/2024</span></p>
                        <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Time: <span className='text-slate-800'>3:00pm</span></p>
                    </div>
                </div>
                <div className='flex flex-row justify-end -mt-6 mb-2'>
                        <a href="#"  onClick={() => toggleConclusion()} className="inline-flex font-medium items-center text-blue-600 hover:underline">
                            Conclusion
                 ...
                 {/* Conclusion */}
                 {show && 
                <div className='flex flex-col relative max-w-sm p-2 bg-red-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
                    <h3 className='text-yellow-500 text-lg font-bold italic '>
                            Conclusion 
                    </h3>
                    <div>
                        <p> Here This is Our Meeting conclusion, we hav find this  solution....</p>
                    </div>
                </div> }    
            </div>          
